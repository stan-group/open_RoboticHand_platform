...
class JointControl(QtWidgets.QWidget):
    ...
    def set_value(self, value: float) -> None:
        ...
        # IMPORTANT: emit change so buttons & manual entry move the hand
        self.valueChanged.emit(self.joint_name, clamped)
...
class HandControlWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        ...
        # Torque buttons
        self.enable_torque_button = QtWidgets.QPushButton("Enable Torque", self)
        self.enable_torque_button.clicked.connect(self.enable_torque)
        root_layout.addWidget(self.enable_torque_button)

        self.disable_torque_button = QtWidgets.QPushButton("Disable Torque", self)
        self.disable_torque_button.clicked.connect(self.disable_torque)
        root_layout.addWidget(self.disable_torque_button)
    ...
    def boot_hand(self) -> None:
        try:
            self.hand = oh.connect_hand(MODEL_PATH)
            self.enable_torque()
            self.sync_from_hand()
    ...
    def enable_torque(self) -> None:
        ...
        try:
            ...
            self.sync_from_hand()
            self.footer.setText("Torque enabled.")
        except Exception as exc:
            self.footer.setText(f"Failed to enable torque: {exc}")
    ...
    def disable_torque(self) -> None:
        ...
        try:
            ...
            self.footer.setText("Torque disabled.")
        except Exception as exc:
            self.footer.setText(f"Failed to disable torque: {exc}")
